...
import 'package:newshub/modules/organization/org_manage_article/update_org_article_bottomsheet.dart';

class OrgArticleDetailView extends StatefulWidget {
  final Map<String, dynamic> article;

  const OrgArticleDetailView({super.key, required this.article});

  @override
  State<OrgArticleDetailView> createState() => _OrgArticleDetailViewState();
}

class _OrgArticleDetailViewState extends State<OrgArticleDetailView> {
  ...
  void _showUpdateBottomSheet() {
    showModalBottomSheet(
      ...
      builder: (context) => UpdateOrgArticleBottomsheet(article: widget.article),
    ).then((_) {
      setState(() {});
    });
  }
